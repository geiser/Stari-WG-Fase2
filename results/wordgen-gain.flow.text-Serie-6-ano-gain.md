...
![](wordgen-gain.flow.text-Serie-6-ano-gain_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
![](wordgen-gain.flow.text-Serie-6-ano-gain_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->

    ## Scale for colour is already present.
    ## Adding another scale for colour, which will replace the existing scale.

![](wordgen-gain.flow.text-Serie-6-ano-gain_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
![](wordgen-gain.flow.text-Serie-6-ano-gain_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->

    ## Scale for colour is already present.
    ## Adding another scale for colour, which will replace the existing scale.

![](wordgen-gain.flow.text-Serie-6-ano-gain_files/figure-gfm/unnamed-chunk-38-1.png)<!-- -->
...
![](wordgen-gain.flow.text-Serie-6-ano-gain_files/figure-gfm/unnamed-chunk-47-1.png)<!-- -->

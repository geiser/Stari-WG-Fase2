...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediatext-from-dfsmediatext-grupo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediatext-from-dfsmediatext-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediatext-from-dfsmediatext-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediatext-from-dfsmediatext-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediatext-from-dfsmediatext-grupo-Serie.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-stari-flow.text-emms.rds')
```

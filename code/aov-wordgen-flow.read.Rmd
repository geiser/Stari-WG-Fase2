...
saveRDS(
  ...
  file = 'WG.Grupo-ancova-fssmediaread-from-dfsmediaread-grupo.rds')
```
...
saveRDS(
  ...
  file = 'WG.Grupo-ancova-fssmediaread-from-dfsmediaread-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'WG.Grupo-ancova-fssmediaread-from-dfsmediaread-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'WG.Grupo-ancova-fssmediaread-from-dfsmediaread-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'WG.Grupo-ancova-fssmediaread-from-dfsmediaread-grupo-Serie.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-wordgen-flow.read-emms.rds')
```

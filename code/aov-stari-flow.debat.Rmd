...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediadebat-from-dfsmediadebat-grupo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediadebat-from-dfsmediadebat-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediadebat-from-dfsmediadebat-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediadebat-from-dfsmediadebat-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-fssmediadebat-from-dfsmediadebat-grupo-Serie.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-stari-flow.debat-emms.rds')
```

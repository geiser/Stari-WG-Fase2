...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabpos-from-vocabpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabpos-from-vocabpre-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabpos-from-vocabpre-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabpos-from-vocabpre-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabpos-from-vocabpre-grupo-Serie.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabpos-from-vocabpre-grupo-vocabquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-stari-vocab-emms.rds')
```

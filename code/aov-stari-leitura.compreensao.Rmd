...
saveRDS(
  list(
    test = "ancova",
    dv = "leitura.compreensao.pos",
    covar = "leitura.compreensao.pre",
    iv = c("grupo"),
    wid = "id",
    transformation = "none",
  ...
  file = 'Stari.Grupo-ancova-leituracompreensaopos-from-leituracompreensaopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-leituracompreensaopos-from-leituracompreensaopre-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-leituracompreensaopos-from-leituracompreensaopre-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-leituracompreensaopos-from-leituracompreensaopre-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-leituracompreensaopos-from-leituracompreensaopre-grupo-Serie.rds')
```
...
saveRDS(
  list(
    ...
    dv = "leitura.compreensao.pos",
    covar = "leitura.compreensao.pre",
    iv = c("grupo","leitura.compreensao.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'Stari.Grupo-ancova-leituracompreensaopos-from-leituracompreensaopre-grupo-leituracompreensaoquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-stari-leitura.compreensao-emms.rds')
```

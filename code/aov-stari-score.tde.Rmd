...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-scoretdepos-from-scoretdepre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-scoretdepos-from-scoretdepre-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-scoretdepos-from-scoretdepre-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-scoretdepos-from-scoretdepre-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-scoretdepos-from-scoretdepre-grupo-Serie.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-scoretdepos-from-scoretdepre-grupo-scoretdequintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-stari-score.tde-emms.rds')
```

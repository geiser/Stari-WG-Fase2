...
saveRDS(
  list(
    test = "ancova",
    dv = "vocab.non.teach.pos",
    covar = "vocab.non.teach.pre",
    iv = c("grupo"),
    wid = "id",
    transformation = "none",
  ...
  file = 'Stari.Grupo-ancova-vocabnonteachpos-from-vocabnonteachpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabnonteachpos-from-vocabnonteachpre-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabnonteachpos-from-vocabnonteachpre-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabnonteachpos-from-vocabnonteachpre-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-vocabnonteachpos-from-vocabnonteachpre-grupo-Serie.rds')
```
...
saveRDS(
  list(
    ...
    dv = "vocab.non.teach.pos",
    covar = "vocab.non.teach.pre",
    iv = c("grupo","vocab.non.teach.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'Stari.Grupo-ancova-vocabnonteachpos-from-vocabnonteachpre-grupo-vocabnonteachquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-stari-vocab.non.teach-emms.rds')
```

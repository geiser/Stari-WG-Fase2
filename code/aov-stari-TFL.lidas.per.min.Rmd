...
saveRDS(
  list(
    test = "ancova",
    dv = "TFL.lidas.per.min.pos",
    covar = "TFL.lidas.per.min.pre",
    iv = c("grupo"),
    wid = "id",
    transformation = "none",
  ...
  file = 'Stari.Grupo-ancova-TFLlidasperminpos-from-TFLlidasperminpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-TFLlidasperminpos-from-TFLlidasperminpre-grupo-Sexo.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-TFLlidasperminpos-from-TFLlidasperminpre-grupo-Zona.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-TFLlidasperminpos-from-TFLlidasperminpre-grupo-CorRaca.rds')
```
...
saveRDS(
  ...
  file = 'Stari.Grupo-ancova-TFLlidasperminpos-from-TFLlidasperminpre-grupo-Serie.rds')
```
...
saveRDS(
  list(
    ...
    dv = "TFL.lidas.per.min.pos",
    covar = "TFL.lidas.per.min.pre",
    iv = c("grupo","TFL.lidas.per.min.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'Stari.Grupo-ancova-TFLlidasperminpos-from-TFLlidasperminpre-grupo-TFLlidasperminquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-WG-Fase2/code/aov-stari-TFL.lidas.per.min-emms.rds')
```
